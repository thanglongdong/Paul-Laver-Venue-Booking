...
class BookingsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'event_type' => ['type' => 'string', 'length' => 64, 'null' => true, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null],
        ...
        '_constraints' => [
            ...
            'FK_BOOKINGS_VENUES' => ['type' => 'foreign', 'columns' => ['venue_id'], 'references' => ['venues', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
            'FK_BOOKINGS_CUSTOMERS' => ['type' => 'foreign', 'columns' => ['customer_id'], 'references' => ['customers', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public function init(): void
    {
        $this->records = [
            [
                'id' => 1,
                'date' => '2021-04-13',
                'start_time' => '2021-04-13 15:11:11',
                'end_time' => '2021-04-13 15:11:11',
